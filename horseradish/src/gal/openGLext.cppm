...
namespace hr::gl::extensions
{
    ...
    GLAPI void(APIENTRYP glPathSubCommandsNV)(GLuint path,
    ...
    GLAPI void(APIENTRYP glPathGlyphsNV)(GLuint firstPathName,
                                         GLenum fontTarget,
                                         const void* fontName,
                                         ...
                                         GLfloat emScale);
    GLAPI void(APIENTRYP glPathGlyphRangeNV)(GLuint firstPathName,
                                             GLenum fontTarget,
                                             const void* fontName,
                                             GLbitfield fontStyle,
                                             GLuint firstGlyph,
    ...
    GLAPI void(APIENTRYP glStencilFillPathInstancedNV)(GLsizei numPaths,
                                                       GLenum pathNameType,
                                                       const void* paths,
                                                       GLuint pathBase,
                                                       GLenum fillMode,
    ...
    GLAPI void(APIENTRYP glStencilStrokePathInstancedNV)(GLsizei numPaths,
                                                         GLenum pathNameType,
                                                         const void* paths,
                                                         GLuint pathBase,
                                                         GLint reference,
    ...
    GLAPI void(APIENTRYP glCoverFillPathInstancedNV)(GLsizei numPaths,
                                                     GLenum pathNameType,
                                                     const void* paths,
                                                     GLuint pathBase,
                                                     GLenum coverMode,
                                                     GLenum transformType,
                                                     const GLfloat* transformValues);
    GLAPI void(APIENTRYP glCoverStrokePathInstancedNV)(GLsizei numPaths,
                                                       GLenum pathNameType,
                                                       const void* paths,
                                                       GLuint pathBase,
                                                       GLenum coverMode,
    ...
    GLAPI void(
      APIENTRYP glGetPathMetricsNV)(GLbitfield metricQueryMask, GLsizei numPaths, GLenum pathNameType, const void* paths, GLuint pathBase, GLsizei stride, GLfloat* metrics);
    ...
    GLAPI void(APIENTRYP glGetPathSpacingNV)(GLenum pathListMode,
                                             GLsizei numPaths,
                                             GLenum pathNameType,
                                             const void* paths,
                                             GLuint pathBase,
    ...
    GLAPI GLboolean(
      APIENTRYP glPointAlongPathNV)(GLuint path, GLsizei startSegment, GLsizei numSegments, GLfloat distance, GLfloat* x, GLfloat* y, GLfloat* tangentX, GLfloat* tangentY);
    ...
    GLAPI void(APIENTRYP glStencilThenCoverFillPathInstancedNV)(GLsizei numPaths,
                                                                GLenum pathNameType,
                                                                const void* paths,
                                                                GLuint pathBase,
                                                                GLenum fillMode,
                                                                ...
                                                                GLenum transformType,
                                                                const GLfloat* transformValues);
    GLAPI void(APIENTRYP glStencilThenCoverStrokePathInstancedNV)(GLsizei numPaths,
                                                                  GLenum pathNameType,
                                                                  const void* paths,
                                                                  GLuint pathBase,
                                                                  GLint reference,
                                                                  ...
                                                                  const GLfloat* transformValues);
    GLAPI GLenum(
      APIENTRYP glPathGlyphIndexRangeNV)(GLenum fontTarget, const void* fontName, GLbitfield fontStyle, GLuint pathParameterTemplate, GLfloat emScale, GLuint baseAndCount[2]);
    GLAPI GLenum(APIENTRYP glPathGlyphIndexArrayNV)(GLuint firstPathName,
                                                    GLenum fontTarget,
                                                    const void* fontName,
                                                    GLbitfield fontStyle,
                                                    ...
                                                    GLuint pathParameterTemplate,
                                                    GLfloat emScale);
    GLAPI GLenum(APIENTRYP glPathMemoryGlyphIndexArrayNV)(GLuint firstPathName,
                                                          GLenum fontTarget,
                                                          GLsizeiptr fontSize,
                                                          const void* fontData,
                                                          GLsizei faceIndex,
    ...
    GLAPI void(APIENTRYP glGetProgramResourcefvNV)(GLuint program,
