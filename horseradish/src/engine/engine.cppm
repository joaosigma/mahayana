...
namespace hr::engine
{
    ...
    private:
        ...
        std::shared_ptr<renderPlatform::Window> mWindow;
...
template<>
bool
hr::engine::Engine::var<bool>(const char* const name) const;
template<>
int32_t
hr::engine::Engine::var<int32_t>(const char* const name) const;
template<>
int64_t
hr::engine::Engine::var<int64_t>(const char* const name) const;
template<>
float
hr::engine::Engine::var<float>(const char* const name) const;
template<>
double
hr::engine::Engine::var<double>(const char* const name) const;
template<>
std::string
hr::engine::Engine::var<std::string>(const char* const name) const;

template<>
void
hr::engine::Engine::var<bool>(const char* const name, const bool& value);
template<>
void
hr::engine::Engine::var<int32_t>(const char* const name, const int32_t& value);
template<>
void
hr::engine::Engine::var<int64_t>(const char* const name, const int64_t& value);
template<>
void
hr::engine::Engine::var<float>(const char* const name, const float& value);
template<>
void
hr::engine::Engine::var<double>(const char* const name, const double& value);
template<>
void
hr::engine::Engine::var<std::string>(const char* const name, const std::string& value);
