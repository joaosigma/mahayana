...
namespace hr::engine
{
    ...
    void Engine::renderLoop()
    {
        ...
        if (Profiler::isSupported())
        {
            ...
            profiler->enableStat(Profiler::StatId::GPUTimeElapsed, Profiler::StatId::GPUSamples, Profiler::StatId::GPUVerticesSubmitted, Profiler::StatId::GPUPrimitivesSubmitted,
                                 Profiler::StatId::GPUVertexShaderInvocations, Profiler::StatId::GPUFragmentShaderInvocations, Profiler::StatId::GPUClipInputPrimitives,
                                 Profiler::StatId::GPUClipOutputPrimitives);
        }
        ...
        // we are about to enter the main render loop
        {
            ...
            hr::gl::objects::Query::Group<8> renderGlQueryGroup = {hr::gl::objects::Query::Type::TimeElapsed,
                                                                   hr::gl::objects::Query::Type::SamplesPassed,
                                                                   hr::gl::objects::Query::Type::VerticesSubmitted,
                                                                   hr::gl::objects::Query::Type::PrimitivesSubmitted,
                                                                   hr::gl::objects::Query::Type::VertexShaderInvocations,
                                                                   hr::gl::objects::Query::Type::FragmentShaderInvocations,
                                                                   hr::gl::objects::Query::Type::ClippingInputPrimitives,
                                                                   hr::gl::objects::Query::Type::ClippingOutputPrimitives};
