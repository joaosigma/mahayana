...
namespace hr::engine
{
    ...
    public:
        ...
        public:
            ...
            T* createClassInstance(const char* className, TValues&&... ctorParams)
            {
                ...
                Runtime::pushFullPathToStack(mSqvm, className, false,
    ...
    public:
        ...
        bool callVoidMethod(const char* const funcName, TValues&&... funcParams)
        {
            ...
            return Runtime::pushFullPathToStack(mVM, funcName, false,
                                                [&](const std::wstring& lastToken)
                                                {
        ...
        void registerClass(const char* const className)
        {
            ...
            Runtime::pushFullPathToStack(mVM, className, false,
                                         [&](const std::wstring& lastToken)
                                         {
    ...
    template<class T>
    std::unordered_map<std::string, typename hr::engine::Runtime::NativeClass<T>::RegisteredClassFuncType> hr::engine::Runtime::NativeClass<T>::sFuncMap;
}
