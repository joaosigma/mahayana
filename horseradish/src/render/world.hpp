#pragma once
#ifndef __HR_RENDER_WORLD__
#define __HR_RENDER_WORLD__
...
//declaração das estructuras para conviniencia
class Light;
class Geometry;
class TextureSet;
class Surface;
...
public:
	...
	HorseRadish::Containers::Array<Texture> texs;
...
public:
	...
	HorseRadish::Containers::Array<Surface*> childs;
...
public:
	struct Shadering
	{
		...
		HorseRadish::Containers::Array<ShaderMap> shaderMaps;
		HorseRadish::Containers::Array<ShaderParam> shaderParams;
	};
...
public:
	HorseRadish::Containers::Array<Light> lights;
	HorseRadish::Containers::Array<Geometry> geometries;
	HorseRadish::Containers::Array<Material> materials;
	HorseRadish::Containers::Array<TextureSet> textureSets;
	
	HorseRadish::Containers::Array<Surface> surfacesTotal;
	HorseRadish::Containers::Array<Surface*> surfacesRoot;

	struct RenderContent{
		Surface **surfaces;
		Light **lights;

		RenderContent() : surfaces(nullptr) , lights(nullptr) { }
	}renderContent;
	...
	int processModel(const HorseRadish::Geometry::Model * const modelo, const Geometry::GeometryType geomType, const bool joinModels);
...
public:
	...
	int ImportHRF(HorseRadish::Streams::Stream * const fileStream);
	int ExportHRF(HorseRadish::Streams::Stream * const fileStream);

	int CreateGeometry3DS(HorseRadish::Streams::StreamReader * const streamReader, const Geometry::GeometryType geomType, const bool joinModels);
	int CreateGeometryOBJ(HorseRadish::Streams::StreamReader * const streamReader, const Geometry::GeometryType geomType, const bool joinModels);
	int CreateGeometryCOLLADA(HorseRadish::Streams::StreamReader * const streamReader, const Geometry::GeometryType geomType, const bool joinModels);
