...
namespace hr::render::tools
{
    ...
    class Font
    {
        ...
        static_assert(std::is_nothrow_copy_constructible_v<CharacterData>, "Base type must be either Vector3f or Vector3d");
        static_assert(std::is_nothrow_move_constructible_v<CharacterData>, "Base type must be either Vector3f or Vector3d");
    ...
    private:
        ...
        //tsl::hopscotch_map<uint32_t, CharacterData> mCharMap;
        ...
        bool initFont(std::string_view fontFilePath);
    ...
    public:
        Font(std::string_view fontFilePath, unsigned int glVertexProgramID, unsigned int glFragmentProgramID, unsigned int glProgramPipelineID);
        ~Font();
