...
namespace hr::render::tools
{
    ...
    bool Font::initFont(const char* const fontFilePath)
    {
        ...
        for (auto& glyphData : validGlyphs)
        {
            ...
            auto bitmapData = stbtt_GetCodepointSDF(&fontInfo, targetScale, glyphData.codepoint, sdfBufferPadding - sdfBufferMargin, 127,
                                                    127.5f / static_cast<float>(sdfBufferPadding - sdfBufferMargin), &bitmapWidth, &bitmapHeight, &bitmapXoff, &bitmapYoff);
      ...
      : mGlVertexProgramID(glVertexProgramID), mGlFragmentProgramID(glFragmentProgramID), mGlProgramPipelineID(glProgramPipelineID)
    {
...

        {
            ...
            mGl.arrayBuffer.init(hr::gl::objects::Buffer::Type::ArrayBuffer, sizeof(Font::VertexDataLayout) * Font::sMumMaxChar * 4,
                                 hr::gl::objects::Buffer::UsageType::PersistentOnlyWrite);
            mGl.elementArrayBuffer.init(hr::gl::objects::Buffer::Type::ElementArrayBuffer, fontIndexArray.get(), sizeof(unsigned short) * Font::sMumMaxChar * 6,
                                        hr::gl::objects::Buffer::UsageType::ServerStatic);
        }
