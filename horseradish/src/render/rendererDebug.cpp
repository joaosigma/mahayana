...
{
	RendererDebug::RendererDebug(const hr::gl::objects::Context& glContext, hr::io::FileSystem& fileSystem, Renderer2D& renderer2D, hr::render::World& renderWorld)
		: Renderer(glContext)
		, mWorld(renderWorld)
	...
	void RendererDebug::render(const tools::Camera& hrCamera, const hr::gl::tools::Viewport& hrViewport)
	{
		{
