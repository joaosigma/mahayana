#pragma once
#ifndef __HR_RENDER_RENDERER_DEFERRED__
#define __HR_RENDER_RENDERER_DEFERRED__
...
private:
	...
	const HorseRadish::OpenGL::Objects::Texture* loadDiffuse(HorseRadish::IO::FileSystem * const fileSystem, TextureSet::Texture* texture);
	const HorseRadish::OpenGL::Objects::Texture* loadNormal(HorseRadish::IO::FileSystem * const fileSystem, TextureSet::Texture* texture);
	void loadTextures(HorseRadish::IO::FileSystem * const fileSystem);
...
public:
	...
	void LoadWorld(HorseRadish::IO::FileSystem * const fileSystem);
