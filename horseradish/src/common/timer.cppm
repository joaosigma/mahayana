...
export namespace hr
{
    ...
    public:
        ...
        std::uint64_t getTimeIntS() const noexcept;
        std::uint64_t getTimeIntS(const bool restart) noexcept;
        std::uint64_t getTimeIntMS() const noexcept;
        std::uint64_t getTimeIntMS(const bool restart) noexcept;

        void setS(const std::uint64_t seconds) noexcept;
        void setS(const double seconds) noexcept;
        void setMS(const std::uint64_t miliseconds) noexcept;
        void setMS(const double miliseconds) noexcept;

        void addS(const std::int64_t seconds) noexcept;
        void addS(const double seconds) noexcept;
        void addMS(const std::int64_t miliseconds) noexcept;
