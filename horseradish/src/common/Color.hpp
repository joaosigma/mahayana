...
public:
	...
	static void ConvertColor(unsigned char *valB, const float * const valF, const bool processAlphaChannel)
	{
		...
		//chegando aqui são 4 componentes
	...
	static void ConvertColor(float * const valF, const unsigned char *valB, const bool processAlphaChannel)
	{
		...
		if (processAlphaChannel == false)
		{
			//converto os 4 bytes para int32
		...
		//calculo o valor final e guardo
		valFinal = _mm_mul_ps(_mm_cvtepi32_ps(valConvert), Math::SIMD::fUByteMaxInv);
...
public:
	...
	void SetYUV(const unsigned char &y, const unsigned char &u, const unsigned char &v)
	{
		...
		//converto os valores para float
		pixelAux[0] = y;
		pixelAux[1] = u;
		pixelAux[2] = v;
		pixelAux[3] = 0.0;
	...
	inline void WriteYUV(unsigned char * const dest) const
	{
		...
		//leio a cor e converto o buffer
	...
	inline void WriteCMYK(float * const dest) const
	{
		...
		//preciso de algumas coisas extra
		w = Math::fMax(this->r, this->g, this->b);
		wInv = 1.0f / w;
	...
	inline void ToGrayscale()
	{
		...
		//calculo o novo cinza
		newLum = r * 0.3019607843f;
	...
	inline void NegativeRGB()
	{
		...
		//guardo o alpha e faço a conta e restauro o alpha
		alphaAux = this->a;
