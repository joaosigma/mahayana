...
#pragma pack(pop)
    ...
    public:
        ...
        const Matrix4f& rootTransform() const noexcept
        {
...
namespace hr
{
    ...
    struct serialize::Support<geom::SkeletonAnim::Joint>
    {
        ...
        static void save(TArchiveWriter& writer, const geom::SkeletonAnim::Joint& joint)
        {
            ...
            writer << NamedParam("scale", joint.localTransform.scale) << NamedParam("translation", joint.localTransform.translation)
                   << NamedParam("rotation", joint.localTransform.rotation) << NamedParam("localTransform", joint.localTransform.matrix);
    ...
    struct serialize::Support<geom::SkeletonAnim::Animation::Sampler>
    {
        ...
        {
            using serialize::NamedParam;
            writer << NamedParam("timePoints", sampler.timePoints) << NamedParam("channels", sampler.channels) << NamedParam("minTimePoint", sampler.minTimePoint)
                   << NamedParam("maxTimePoint", sampler.maxTimePoint);
        }
    ...
    struct serialize::Support<geom::SkeletonAnim::Animation>
    {
        ...
        {
            using serialize::NamedParam;
            writer << NamedParam("id", anim.name) << NamedParam("samplers", anim.samplers) << NamedParam("minTimePoint", anim.minTimePoint)
                   << NamedParam("maxTimePoint", anim.maxTimePoint);
        }
