...
#define GETADDR_NATIVE(var, name, type)                                                                                                                                            \
    if ((var = (type)GetProcAddress(nativeOpenGLModule, name)) == nullptr)                                                                                                         \
        return false;
#define GETADDR_BASE(var, name, type)                                                                                                                                              \
    if ((var = (type)wglProcAddressOpenGL(name)) == nullptr)                                                                                                                       \
        return false;
...
namespace hr::gl
{
    namespace
    {
        ...
        bool loadGLFunctions(HINSTANCE nativeOpenGLModule, PFNWGLGETPROCADDRESSPROC wglProcAddressOpenGL)
        {
            ...
            GETADDR_BASE(glSpecializeShader, "glSpecializeShader", PFNGLSPECIALIZESHADERPROC);
            GETADDR_BASE(glMultiDrawArraysIndirectCount, "glMultiDrawArraysIndirectCount", PFNGLMULTIDRAWARRAYSINDIRECTCOUNTPROC);
            GETADDR_BASE(glMultiDrawElementsIndirectCount, "glMultiDrawElementsIndirectCount", PFNGLMULTIDRAWELEMENTSINDIRECTCOUNTPROC);
            GETADDR_BASE(glPolygonOffsetClamp, "glPolygonOffsetClamp", PFNGLPOLYGONOFFSETCLAMPPROC);
#endif
