export module core:taggedPointer;
...
export namespace hr
{
    ...
    private:
        ...
        static const std::intptr_t TagMask = AlignedTo - 1;
        ...
        static const std::intptr_t PointerMask = ~TagMask;
    ...
    public:
        ...
        {
            assert((reinterpret_cast<std::intptr_t>(pointer) & TagMask) == 0); // make sure that the pointer really is aligned
