...
namespace Catch
{
	...
	struct StringMaker<hr::Matrix4f>
	{
		...
		{
			return std::format("Matrix is: {{{{{}, {}, {}, {}}}, {{{}, {}, {}, {}}}, {{{}, {}, {}, {}}}, {{{}, {}, {}, {}}}}}", m[0], m[1], m[2], m[3], m[4], m[5],
...
namespace hr::utests
{
	...
	struct Vector4EqualsMatcher : Catch::Matchers::MatcherGenericBase
	{
		...
		bool match(const TVector& v) const
		{
			...
			return (v[0] == Catch::Approx(m_x).epsilon(0.001).margin(0.0000001)) &&
				(v[1] == Catch::Approx(m_y).epsilon(0.001).margin(0.0000001)) &&
				(v[2] == Catch::Approx(m_z).epsilon(0.001).margin(0.0000001)) &&
				(v[3] == Catch::Approx(m_w).epsilon(0.001).margin(0.0000001));
		}
	...
	struct Matrix3EqualsMatcher : Catch::Matchers::MatcherGenericBase
	{
		...
		std::string describe() const override
		{
			return std::format("Matrix3x3 is: {{{{{}, {}, {}}}, {{{}, {}, {}}}, {{{}, {}, {}}}}}", m_mat[0], m_mat[1], m_mat[2], m_mat[3], m_mat[4], m_mat[5], m_mat[6],
			  m_mat[7], m_mat[8]);
		}
