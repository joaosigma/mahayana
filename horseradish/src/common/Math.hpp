...
#pragma warning( push )
#pragma warning( disable : 4800 )	//tirar o warning "forcing value to bool 'true' or 'false' (performance warning)"
#pragma warning( disable : 4018 )	//tirar o warning "signed/unsigned mismatch"
...
public:
	...
	class SIMD {
		public:
			...
			static void sinCosG(__m128 graus, __m128 * const s, __m128 * const c);
	...
	static float				sinG( const float &graus );
	static float				cosR( const float &radians );
	static float				cosG( const float &graus );
	...
	static void					sinCosG( const float graus, float &s, float &c );
...
//§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
//§§§§   -= Implementar algumas (mais exóticas) =-   §§§§§
//§§§§    estas são aquelas que só dão em floats	 §§§§§
//§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
inline
...
inline
float Math::sinG( const float &graus )
{	return sinf( graus * 0.01745329251994329576923690f);}
...
inline
float Math::cosG( const float &graus )
{	return cosf( graus * 0.01745329251994329576923690f);}
...
inline
void Math::sinCosG( const float graus, float &s, float &c )
{
#ifdef _M_X64
	__m128 sin, cos;
	SIMD::sinCosG(_mm_load_ps1(&graus), &sin, &cos);
	s = sin.m128_f32[0];
	c = cos.m128_f32[0];
#else
	_asm {
...
//§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
//§§§§   -= Implementar algumas (em inteiros) =-   §§§§§
//§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
inline
