...
namespace hr::utests
{
    namespace
    {
        ...
        {
            Random r;
            return Vector4f(static_cast<float>(r.nextDouble(-10.0, 10.0)), static_cast<float>(r.nextDouble(-10.0, 10.0)), static_cast<float>(r.nextDouble(-10.0, 10.0)),
    ...
    TEST_CASE("4 component vector of type float", "[common][vector][vector4f]")
    {
        ...
        SECTION("pointAt")
        {
            ...
            v1 = randomVector4f();
            v2 = Vector4f::calcNormalize(randomVector4f());
            REQUIRE_THAT(Vector4f::calcPointAt(v1, v2, (-4.33f)),
                         VectorEquals(v2[0] * (-4.33f) + v1[0], v2[1] * (-4.33f) + v1[1], v2[2] * (-4.33f) + v1[2], v2[3] * (-4.33f) + v1[3]));
        }
