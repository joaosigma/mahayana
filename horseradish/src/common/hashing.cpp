...
namespace hr
{
	namespace
	{
		constexpr unsigned char crctable8[256] = {
		...
		constexpr unsigned short crctable16[256] = {
		...
		constexpr unsigned long crctable32[256] = {
	...
	void Hashing::calculateMD5(const void * const buffer, size_t bufferSize, types::hData128 * const hash) noexcept
	{
		...
		MD5 context;
		MD5Open(&context);
		MD5Digest(&context, buffer, bufferSize);
	...
	void Hashing::calculateSHA256(const void * const buffer, size_t bufferSize, types::hData128 * const hash) noexcept
	{
		...
		sha256_init(&context);
		sha256_hash(&context, buffer, bufferSize);
