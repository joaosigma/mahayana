...
{
	//posso estimar um tamanho final
...
{
	//base64 ocupa 137% do tamanho original, ou seja, é preciso dividir por 1.37, o que equivale a multiplicar por 0.73, que por sua vez é aproximado por 3/4
...
{
	//o tamanho da string tem de seguir algumas regras
	...
	int bytesWritten = 0;
	auto *inWalker = (const unsigned char *)dataHex.GetData();

	//para cada dois caracteres
