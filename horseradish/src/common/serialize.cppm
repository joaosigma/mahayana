...
export module core:serialize;

import std;

export namespace hr::serialize
{
    template<class T>
    struct NamedParam
    {
    ...
    namespace traits
    {
        namespace detail
        {
            ...
            {};
            template<typename T>
            struct is_std_span<const std::span<T>>: std::true_type
            {};
            template<typename T, size_t N>
            struct is_std_span<std::span<T, N>>: std::true_type
            {};
            template<typename T, size_t N>
            struct is_std_span<const std::span<T, N>>: std::true_type
            {};
            ...
            struct is_std_vector<std::vector<TArgs...>>: std::true_type
            {};
            ...
            {};
            template<typename... TArgs>
            struct is_std_shared_ptr<std::shared_ptr<TArgs...>>: std::true_type
            {};
            ...
            {};
            template<typename... TArgs>
            struct is_std_unique_ptr<std::unique_ptr<TArgs...>>: std::true_type
            {};
            ...
            {};
            template<typename... TArgs>
            struct is_std_optional<std::optional<TArgs...>>: std::true_type
            {};

            template<typename T>
            struct is_named_param: std::false_type
            {};
            template<typename... TArgs>
            struct is_named_param<NamedParam<TArgs...>>: std::true_type
            {};
        };
