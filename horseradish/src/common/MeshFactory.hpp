#pragma once
#ifndef __HMESH_FACTORY__
#define __HMESH_FACTORY__
...
public://private:
	HorseRadish::Containers::Array<MeshData> arrayMesh;
...
private:
	...
	static void divide_patch(Mesh * const mesh, const HorseRadish::Vector p[4][4], const int n, int * const curVert);
...
public:
	...
	static Model* Read3DS(HorseRadish::Streams::StreamReader * const streamReader);
	static Model* ReadOBJ(HorseRadish::Streams::StreamReader * const streamReader);
	static Model* ReadCollada(HorseRadish::Streams::StreamReader * const streamReader);
};
